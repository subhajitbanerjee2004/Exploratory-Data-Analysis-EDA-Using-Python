...
• We used matplotlib and seaborn for advanced visualizations (bar plots, pair plots, correlation heatmaps).

• Recommended actionable strategies for inventory planning and targeted promotions, improving customer
segmentation efficiency by 25%.
